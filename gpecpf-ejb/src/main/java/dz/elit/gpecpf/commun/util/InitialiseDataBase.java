...
//------------------------------------------------------------------------------------------------------------------        
 //***************** Fin Initialisation Module Administration *************************************************************************
		...
		em.persist(new AdminPrivilege("REFER_008_006", "Lister les postes ", adminModule));
                ...
                em.persist(new AdminPrivilege("REFER_009_001", "Créer une comportement ", adminModule));
		em.persist(new AdminPrivilege("REFER_009_002", "Modifier un comportement ", adminModule));
		em.persist(new AdminPrivilege("REFER_009_003", "Supprimer un comportement ", adminModule));
		em.persist(new AdminPrivilege("REFER_009_004", "Rechercher un comportement ", adminModule));
		em.persist(new AdminPrivilege("REFER_009_005", "Consulter un comportement ", adminModule));
		em.persist(new AdminPrivilege("REFER_009_006", "Lister les comportements ", adminModule));
